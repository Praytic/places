 ...
 * @returns {Set<PlaceGroup>} activeFilters - Set of active place groups
...
export const useActiveFilters = (): {
  ...
  setActiveFilters: React.Dispatch<React.SetStateAction<Set<PlaceGroup>>>;
} => {
  const [activeFilters, setActiveFilters] = useState<Set<PlaceGroup>>(() => {
